...
# Create plot of Voltage in time 
plot(dataSubset$Date_Time, dataSubset$Voltage, type="l",
...
# Create plot of Global Active Power in time 
plot(dataSubset$Date_Time, dataSubset$Global_reactive_power, type="l",
